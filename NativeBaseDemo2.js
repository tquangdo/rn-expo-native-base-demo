...
export default class CardComponent extends Component {
  render() {
    return <SafeAreaView>
      ...
      <ScrollView>
        <Card>
          <CardItem style={{ justifyContent: 'center', }} header bordered>
            <Text>Profile</Text>
          </CardItem>
          <CardItem>
            <Left>
          ...
          <CardItem style={{ height: 60 }} footer bordered>
            <Text>1000 likes</Text>
          </CardItem>
          <CardItem>
            <Body>
              <Text>
                I am <Text style={{ fontWeight: 'bold' }}>DoTQ</Text>, I live in HCM, Vietnam.
